...
function populateStates( countryElementId, stateElementId ){
	...
	if( selectedCountryIndex && stateElement ){
...
function populateCountries(countryElementId, stateElementId, selectedCountryName){
	...
	if( countryElement ){
		...
		for (var i=0; i<country_arr.length; i++) {
			...
			if(country_arr[i] === selectedCountryName) {
