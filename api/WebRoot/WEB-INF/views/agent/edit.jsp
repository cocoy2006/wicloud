...
<html lang="en">
	...
	<body>
	    ...
	    function initItem() {
	    	...
	    	if(itemId && itemId != "0") {
	    		// fill item
	    		var option = '<option>请选择行业类别</option>';
		    	...
		    	$("#item").html(option);
		    	// fill sub item
		    	$("#subItem").html('<option selected="selected">请选择商铺性质</option>');
	    	}
